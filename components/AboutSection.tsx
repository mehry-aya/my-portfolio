            ...
            <div className='my-12 pb-12 md:pt-16 md:pb-48'>
                ...
                <div className='flex flex-col space-y-10 items-stretch justify-center align-top md:flex-row md:text-left md:p-4 md:space-x-10 md:space-y-0'>
                    <div className='md:w-1/2'>
                        ...
                        <br />
                        <p>
                            I graduated from International Multidisciplinary School, Sousse in 2024
                    ...
                    width={350}
                    height={350}
                    className='hidden md:block md:relative md:bottom-9 md:left-24 md:z-0'
                    />
                    </div>
                </div>
            </div>
